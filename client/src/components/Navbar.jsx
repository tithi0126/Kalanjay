    ...
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-lg border-b border-neutral-200 shadow-sm transition-all duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          >
            <div className="relative h-11 w-11 md:h-12 md:w-12 rounded-2xl bg-gradient-to-br from-theme-red to-theme-salmon flex items-center justify-center text-white font-extrabold text-xl shadow-xl shadow-theme-red/30 group-hover:scale-105 group-hover:rotate-3 transition-all duration-300">
              K
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] md:text-xs text-neutral-600 font-semibold tracking-wider uppercase">
                Gifts with Love
              </span>
            </div>
          </Link> */}
...
>
 ...
 > Buy through WhatsApp</span>
          </a>

          {/* Mobile Menu Button (can be wired up to a drawer later) */}
          <button
            type="button"
